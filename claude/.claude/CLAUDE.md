...
IMPORTANT: For strict enforcement, use the `cc` alias which injects these as system prompt.
...
- **Plan complex tasks**: Use extended thinking for architectural decisions
...
- **Context7 MCP**: ALWAYS use Context7 MCP for library/API documentation, code generation, setup or configuration steps
